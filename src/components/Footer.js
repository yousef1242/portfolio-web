    ...
    <footer className='footer'>
       <Container style={{width:"70%",margin:"0px auto"}}>
          <Row>
             ...
             <div className='col-xxl-6 col-lg-6 col-md-6 col-sm-12 text-end'>
             <a href="https://www.instagram.com/frontend709/" style={{color:"#fff",fontSize:"20px"}} target="_blank"><i class="fa-brands fa-instagram"></i></a>
