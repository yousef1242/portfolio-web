    ...
    <>
        ...
        <Container style={{ width: "80%", margin: "0px auto" }}>
          <Row>
            ...
            >
              ...
              >
                I'M{" "}
                <span style={{ color: "var(--main-color)" }}>YOUSEF AHMED</span>
              </h1>
      ...
      <div className="home-about py-4" id="aboutMe">
        <Container>
          <h1
            ...
            style={{ color: "#fff", marginBottom: "3rem" }}
          >
          ...
          <Row className="align-items-center" style={{ lineHeight: "40px" }}>
            ...
            >
              <p style={{ color: "white", fontSize: "19px" }}>
                ...
                with experience in developing web. I specialize in using
                programming languages such as{" "}
                <span style={{ color: "var(--main-color)" }}>
                  HTML, CSS, JavaScript, React, Nodejs, Expressjs, MongoDB, JWT and Reset Api
                </span>
                , as well as other frameworks like Bootstrap and Material-UI. I
                have experience in developing quality-supported systems,
                ensuring that the projects
                <span style={{ color: "var(--main-color)" }}>
                  {" "}
                  I oversee are of the highest quality and performance
                </span>{" "}
                .
              </p>
            </div>
      ...
      <div className="video-section container py-5">
        ...
        <h2 style={{ color: "#fff", textAlign: "center" }}>
          Check out my profile on fiverr:{" "}
          <a
            style={{ fontSize: "16px" }}
            href="https://www.fiverr.com/yousefjoo766"
            target="_blank"
          >
            https://www.fiverr.com/yousefjoo766
          </a>
        </h2>
      </div>
      ...
      <div className="touch text-center py-5">
        ...
        <a href="https://www.instagram.com/web_storm75/" target="_blank">
          <i class="fa-brands fa-instagram"></i>
        </a>
        <a
          style={{ marginLeft: "20px" }}
          href="https://web.facebook.com/profile.php?id=100088567061728"
          target="_blank"
        >
        ...
        <a
          style={{ marginLeft: "20px" }}
          href="https://github.com/yousef1242?tab=repositories"
          target="_blank"
        >
